...
public class RoleController {
    ...
    @GetMapping("/getRolesPage/{page}/{limit}")
    public R getRolesPage(
        ...
        return R.ok().data("roles", pageParam.getRecords()).data("total", pageParam.getTotal());
    }
    ...
    public R batchDelete(@RequestBody List<String> idList) {
